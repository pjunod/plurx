...
### 3.4 Historical version snapshot; current Apple source is build 44
...
release instructions. Current source is workspace `0.2.7` and Apple build 44;
...
assigned to the next TestFlight build (≥ 6). Current source is build 44 and is
...
- [ ] Apple build 44 to TestFlight. Android native-subtitle parity shipped in a

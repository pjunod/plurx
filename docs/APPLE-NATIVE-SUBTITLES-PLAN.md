...
### 3.4 Historical version snapshot; current Apple source is build 43
...
release instructions. Current source is workspace `0.2.7` and Apple build 43;
...
assigned to the next TestFlight build (≥ 6). Current source is build 43 and is
...
- [ ] Apple build 43 to TestFlight. Android native-subtitle parity shipped in a

...
> Status (2026-08-21): source is v0.2.7, Apple build 70. Native text
...
> landed. Build 70 marks a duration-estimated Skip Credits button as an
> estimate, so it no longer reads exactly like a chapter-derived one. Build 69
> adds in-app online EPUB reading on iPhone/iPad through an
...
> resolved status. Repository evidence still says build 69 has not reached

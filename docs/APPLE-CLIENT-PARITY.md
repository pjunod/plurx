...
> Status (2026-08-21): source is v0.2.7, Apple build 76. Native text
...
> landed. Build 76 marks a duration-estimated Skip Credits button as an estimate
> so it no longer reads exactly like a chapter-derived marker. Build 75 adds online PDFKit reading on iPhone/iPad with

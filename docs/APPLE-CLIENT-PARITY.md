...
> Status (2026-08-21): source is v0.2.7, Apple build 71. Native text
...
> landed. Build 71 marks a duration-estimated Skip Credits button as an
> estimate, so it no longer reads exactly like a chapter-derived one. Build 70
> adds profile-scoped, atomically published offline EPUBs,

...
> Status (2026-08-11): source is v0.2.7, Apple build 49. Native text
...
> landed. Build 49 first resets a stalled growing-HLS item against its existing
> session, and a necessary replacement skips copy-keyframe preroll instead of
> replaying it. Build 46 also emits the Performance II N0 TTFF beacon at the first

...
> Status (2026-08-21): source is v0.2.7, Apple build 74. Native text
...
> landed. Build 74 preserves the full tab shell when offline downloads open
> first, so reconnect and Settings remain reachable, and marks a duration-
> estimated Skip Credits button as an estimate rather than presenting it like
> a chapter-derived marker. Build 72 displays bounded book author metadata and only exact

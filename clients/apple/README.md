...
> same regression suite. Build 70 tells a viewer when a Skip Credits button
> came from a duration estimate rather than a real chapter, so a guess no
> longer reads as an exact marker. Build 69 adds in-app online EPUB reading on iPhone

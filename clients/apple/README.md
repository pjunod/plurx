...
> same regression suite. Build 66 adds unattended physical-device bandwidth
> acceptance with exact runway evidence and keeps the delivery watchdog honest
> about a player that is still making progress. Build 64 stops the delivery watchdog firing on a

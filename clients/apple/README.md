...
> Status: **v0.2.2**, build `9` in [`project.yml`](project.yml) — working
...
> same regression suite. Build 9 carries the 2026-08-03 Dolby Vision
> compatibility and appearance-settings fixes and is installed on the paired

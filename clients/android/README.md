...
> Status: **v0.2.7**, build `21` — native viewer parity across phone, foldable,
...
> subtitle selection, and build 21 coalesces hidden-control seeks, restores
> position feedback, and pins media-origin consumption. The

...
> Status: **v0.1.0** — native viewer parity across phone, foldable, and TV.
...
- **Browse and search** across libraries; sort and filter grids, open shows →
  seasons → episodes, and view home-video folders and photos.
...
- **Player** built on ExoPlayer:
  ...
  - Auto / Original / 1080p / 720p / 480p quality, persistent A/V sync
    correction, auto-skip, autoplay-next, playback decision details, media
    sessions, and picture-in-picture on supported devices.
...
With an emulator running, the Compose theme/layout check is:
...
- TV row-memory and initial-focus polish beyond the current D-pad focus states.

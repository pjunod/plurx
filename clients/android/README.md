...
> Status: **v0.2.7**, build `33` — native viewer parity across phone, foldable,
> and TV. Build 33 combines bounded stall recovery for adaptive playback with in-app
> online EPUB reading on phones and tablets with

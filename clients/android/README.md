...
> Status: **v0.2.7**, build `23` — native viewer parity across phone, foldable,
...
> position feedback, and pins media-origin consumption, and build 22 restores
> on-device Compose instrumentation on Android 17 with Espresso 3.7.0, and
> build 23 reapplies the saved download-network policy before restoring an
> interrupted transfer after process death. The
